"""Tails a given file every 10 seconds"""
import time

# Code lifted from http://www.dabeaz.com/generators/follow.py

def follow(thefile, delay=10):
    thefile.seek(0,2)
    while True:
...
if __name__ == '__main__':
    logfile = open("/Users/Abhishek/src/datadog/assets/data.log","r")
